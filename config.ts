...
const config = {
  // REQUIRED
  appName: "Dobi Steel Fixing Pty Ltd",
  // REQUIRED: a short description of your app for SEO tags (can be overwritten)
  appDescription:
    "Professional steel fixing and construction services management system for Dobi Steel Fixing Pty Ltd.",
  // REQUIRED (no https://, not trailing slash at the end, just the naked domain)
  domainName: "dobisteel.com.au",
  crisp: {
    ...
    plans: [
      {
        ...
        description: "Essential tools for small construction teams",
      ...
      },
      {
        ...
        isFeatured: true,
        name: "Professional",
        description: "Complete solution for growing construction companies",
        price: 149,
        priceAnchor: 299,
        features: [
          {
  ...
  resend: {
    ...
    fromNoReply: `Dobi Steel Fixing Pty Ltd <noreply@dobisteel.com.au>`,
    // REQUIRED — Email 'From' field to be used when sending other emails, like abandoned carts, updates etc..
    fromAdmin: `Admin at Dobi Steel <admin@dobisteel.com.au>`,
    // Email shown to customer if they need support. Leave empty if not needed => if empty, set up Crisp above, otherwise you won't be able to offer customer support."
    supportEmail: "support@dobisteel.com.au",
  },
  colors: {
